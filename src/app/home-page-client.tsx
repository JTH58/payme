...
function HomeIntroSection() {
  return (
    <section className="w-full max-w-5xl mx-auto mt-12 md:mt-16">
      <div className="glass-panel rounded-[2rem] p-6 sm:p-8 md:p-10">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start max-w-4xl mx-auto">
          <div className="space-y-5 text-left">
            <div className="theme-badge inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs font-medium mx-auto">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm sm:text-base leading-7 text-slate-600 max-w-2xl mx-auto">
...
function HomeContent() {
  ...
  const initialBankCode = searchParams.get('bankCode');
